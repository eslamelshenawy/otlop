...
@section('title',trans('admin.Request'))
...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('admin.View Request')</li>
        </ol>
    </section>
@endsection()
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        {!! Form::open(['id'=>'form_data','url'=>route('admin.request-working.destroy.all'),'method'=>'delete']) !!}
