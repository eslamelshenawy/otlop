@if(auth()->guard('admin')->user()->hasPermission('delete_request'))
<button type="button" class="btn btn-info  btn btn-danger" data-toggle="modal"
        data-target="#deleteRequest{!! $id !!}"><i class="fa fa-trash"></i></button>

<!-- Modal -->
<div id="deleteRequest{!! $id !!}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['route'=>['admin.request-working.destroy',$id],'method'=>'delete']) !!}
