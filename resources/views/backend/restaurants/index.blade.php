...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('admin.View Restaurants')</li>
        </ol>
    </section>
@endsection()
...
@section('main-content')
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">@lang('admin.View Restaurants')</h3>
                <div class="box-tools pull-right">
                    <div class="form-group">
                        @if(auth()->user()->hasPermission('create_restaurants'))
                            <a href="{{routeAdmin('restaurants.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Add Restaurant')</a>
                        @else
                            <a  class="btn btn-primary disabled"><i class="fa fa-plus-circle"> </i> @lang('admin.Add Restaurant')</a>
                        @endif
                    </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        {!! Form::open(['id'=>'form_data','url'=>route('admin.restaurants.destroy.all'),'method'=>'delete']) !!}
    ...
    @push('js')
        @if(auth()->user()->hasPermission('delete_restaurants'))
        <script>
            delete_all();
        </script>
        @endif
