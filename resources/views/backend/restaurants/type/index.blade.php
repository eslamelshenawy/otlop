...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('admin.View Type')</li>
        </ol>
    </section>
@endsection()
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">@lang('admin.View Type')</h3>
                <div class="box-tools pull-right">
                    <div class="form-group">
                        @if(Auth::guard('admin')->user()->hasPermission('create_restaurants'))
                            <a href="{{routeAdmin('types.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Add Type')</a>
                        @else
                            <a  class="btn btn-primary disabled"><i class="fa fa-plus-circle"> </i> @lang('admin.Add Type')</a>
                        @endif
                    </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        {!! Form::open(['id'=>'form_data','url'=>route('admin.types.destroy.all'),'method'=>'delete']) !!}
