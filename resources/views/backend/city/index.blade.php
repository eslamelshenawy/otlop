...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('admin.View Cities')</li>
        </ol>
    </section>
@endsection()
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">@lang('admin.View Cities')</h3>
                <div class="box-tools pull-right">
                    <div class="form-group">
                        @if(auth()->guard('admin')->user()->hasPermission('create_cities'))
                            <a href="{{routeAdmin('city.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Add City')</a>
                        @else
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        {!! Form::open(['id'=>'form_data','url'=>route('admin.city.destroy.all'),'method'=>'delete']) !!}
