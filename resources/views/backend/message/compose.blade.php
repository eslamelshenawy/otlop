        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    {!! Form::open(['url'=>route('admin.send.messages.mail'),'method'=>'POST','files'=>true]) !!}
                    <div class="box-body">
                        <div class="form-group">
                            <input class="form-control" value="{{old('emailTo')}}" placeholder="@lang('admin.To:')" name="emailTo">
                        </div>
                        <div class="form-group">
                            {!! Form::select('type',['vendor'=>trans('web.Vendor')
                              ,'customer'=>trans('web.User'),'delivery'=>trans('web.Delivery')
                              ,'others'=>trans('web.Others')],old('type'),['class'=>'form-control select2','style'=>'width: 100%;','placeholder'=>trans('web.Select user type')]) !!}
                        </div>
                        <div class="form-group">
                            <input class="form-control" value="{{old('subject')}}" placeholder="@lang('admin.Subject:')" name="subject">
                        </div>
                        <div class="form-group">
                            <textarea id="compose-textarea" name="message"  class="form-control" placeholder="@lang('admin.Messages')" style="height: 300px">{{old('message')}}</textarea>
                        </div>
                    </div>
                    <!-- /.box-body -->
