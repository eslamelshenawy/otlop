...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('admin.View Privacy')</li>
        </ol>
    </section>
@endsection()
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">@lang('admin.View Privacy')</h3>
                <div class="box-tools pull-right">
                    <div class="form-group">
                        @if(auth()->guard('admin')->user()->hasPermission('create_privacy'))
                            <a href="{{routeAdmin('privacy.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Add privacy')</a>
                        @else
                            <a  class="btn btn-primary disabled"><i class="fa fa-plus-circle"> </i> @lang('admin.Add privacy')</a>
                        @endif
                    </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        {!! Form::open(['id'=>'form_data','url'=>route('admin.privacy.destroy.all'),'method'=>'delete']) !!}
