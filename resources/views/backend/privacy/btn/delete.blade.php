...
<button type="button" class="btn btn-info  btn btn-danger" data-toggle="modal"
        data-target="#deletePrivacy{!! $id !!}"><i class="fa fa-trash"></i></button>

<!-- Modal -->
<div id="deletePrivacy{!! $id !!}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['route'=>['admin.privacy.destroy',$id],'method'=>'delete']) !!}
