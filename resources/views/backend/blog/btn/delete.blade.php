...
<button type="button" class="btn btn-info  btn btn-danger" data-toggle="modal"
        data-target="#deleteBlog{!! $id !!}"><i class="fa fa-trash"></i></button>

<!-- Modal -->
<div id="deleteBlog{!! $id !!}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['route'=>['admin.blog.destroy',$id],'method'=>'delete']) !!}
