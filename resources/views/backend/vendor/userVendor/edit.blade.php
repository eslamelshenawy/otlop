    ...
    <section class="content">
        ...
        <div class="row">
            <div class="box box-primary">
                ...
                {!! Form::open(['url'=>route('admin.admin.update',$admin->id),'method'=>'PUT','files'=>true,'role'=>'form','id'=>'formABC']) !!}
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                $admin->status,['class'=>'form-control select2','style'=>'width: 100%;']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="nav-tabs-custom">
                                        @php
                                            $models = ['user_vendors','location','menu','account_vendor','meal_food','offer'];
