...
@section('main-content')
            ...
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    <div class="form-group">
                        @if(auth()->user()->hasPermission('create_user_vendors'))
                            <a href="{{route('vendor.userVendor.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Add Admin')</a>
                        @else
    ...
    @push('js')
        @if(Auth::guard('admin')->user()->hasPermission('delete_user_vendors'))
        <script>
            delete_all();
        </script>
        @endif
