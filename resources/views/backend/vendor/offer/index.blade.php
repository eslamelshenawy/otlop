...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('admin.View Offer')</li>
        </ol>
    </section>
@endsection()
...
@section('main-content')
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">@lang('admin.View Offer')</h3>
                <div class="box-tools pull-right">
                    <div class="form-group">
                        @if(auth()->guard('admin')->user()->hasPermission('create_offer'))
                            <a href="{{route('vendor.offer.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Add Offer')</a>
                        @else
                            <a  class="btn btn-primary disabled"><i class="fa fa-plus-circle"> </i> @lang('admin.Add Offer')</a>
                        @endif
                    </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        {!! Form::open(['id'=>'form_data','url'=>route('vendor.offer.destroy.all'),'method'=>'delete']) !!}
    ...
    @push('js')
        @if(auth()->guard('admin')->user()->hasPermission('delete_offer'))
        <script>
            delete_all();
        </script>
        @endif
