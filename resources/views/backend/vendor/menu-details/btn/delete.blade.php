...
<button type="button" class="btn btn-info  btn btn-danger" data-toggle="modal"
        data-target="#deleteMenuDetails{!! $id !!}"><i class="fa fa-trash"></i></button>

<!-- Modal -->
<div id="deleteMenuDetails{!! $id !!}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['route'=>['vendor.menu-details.destroy',$id],'method'=>'delete']) !!}
