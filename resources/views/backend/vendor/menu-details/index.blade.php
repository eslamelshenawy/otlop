...
@section('title',trans('admin.Meal Food'))

@section('content-header')
    <section class="content-header">
        <h1>
            @lang('admin.Meal Food')
            <small>@lang('admin.Control panel')</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{route('vendor.home')}}"><i class="fa fa-dashboard"></i> @lang('admin.Home')</a></li>
            <li class="active">@lang('admin.View Meal Food')</li>
        </ol>
    </section>
@endsection()
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">@lang('admin.View Meal Food')</h3>
                <div class="box-tools pull-right">
                    <div class="form-group">
                        @if(auth()->guard('admin')->user()->hasPermission('create_menu'))
                            <a href="{{route('vendor.menu-details.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Add Menu')</a>
                        @else
                            <a  class="btn btn-primary disabled"><i class="fa fa-plus-circle"> </i> @lang('admin.Add Menu')</a>
                        @endif
                    </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        {!! Form::open(['id'=>'form_data','url'=>route('vendor.menu-details.destroy.all'),'method'=>'delete']) !!}
