...
<button type="button" class="btn btn-info  btn btn-danger" data-toggle="modal"
        data-target="#deleteOrder{!! $id !!}"><i class="fa fa-trash"></i></button>

<!-- Modal -->
<div id="deleteOrder{!! $id !!}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['route'=>['vendor.order.destroy',$id],'method'=>'delete']) !!}
            <div class="modal-body">
                <h4>@lang('admin.Are your sure delete this') OrderID#{!! $id !!}</h4>
            </div>
