                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="activity">
                            {!! Form::open(['url'=>route('vendor.profile.update'),'method'=>'POST','class'=>'form-horizontal','files'=>true]) !!}
                        ...
                        <div class="tab-pane" id="timeline">
                            {!! Form::open(['url'=>route('vendor.change.password'),'method'=>'POST','class'=>'form-horizontal','file'=>true]) !!}
                            <input hidden name="id" value="{{$data->id}}">
                            <div class="form-group">
