...
<button type="button" class="btn btn-info  btn btn-danger" data-toggle="modal"
        data-target="#deleteState{!! $id !!}"><i class="fa fa-trash"></i></button>

<!-- Modal -->
<div id="deleteState{!! $id !!}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['route'=>['admin.state.destroy',$id],'method'=>'delete']) !!}
