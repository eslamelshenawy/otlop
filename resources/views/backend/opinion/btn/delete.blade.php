...
<button type="button" class="btn btn-info  btn btn-danger" data-toggle="modal"
        data-target="#deleteOpinion{!! $id !!}"><i class="fa fa-trash"></i></button>

<!-- Modal -->
<div id="deleteOpinion{!! $id !!}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['route'=>['admin.opinion.destroy',$id],'method'=>'delete']) !!}
            <div class="modal-body">
                <h4>@lang('admin.Are your sure delete this') </h4>
            </div>
