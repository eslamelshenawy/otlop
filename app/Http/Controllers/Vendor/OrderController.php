...
class OrderController extends Controller
{
    ...
    {
        try{
            return $orderDataTable->render('backend.vendor.order.index');
    ...
    {
        try{
            return view('backend.vendor.order.create');
    ...
    public function edit($id)
    {
        try{
            ...
            {
                return view('backend.vendor.order.edit',compact('order'));
            }
