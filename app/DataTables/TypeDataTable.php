...
class TypeDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'backend.restaurants.type.btn.checkbox')
            ->addColumn('edit', 'backend.restaurants.type.btn.edit')
            ->addColumn('status', 'backend.restaurants.type.btn.status')
            ->addColumn('delete', 'backend.restaurants.type.btn.delete')
            ->rawColumns([
                'edit',
                'status',
                'delete',
    ...
    public function query()
    {
        ...
        return TypeTranslation::query()->join('types','type_translations.type_id','=','types.id')
            ->where('locale',\App::getLocale())
            ->select('types.id as id','type_translations.name as name','types.status as status');
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'=>[
                    [
                        'text'=>'<i class="fa fa-plus-circle"></i> '.trans('admin.Create Type'),
                    ...
                    ['extend' =>'reload','className'=>\Auth::guard('admin')->user()->hasPermission('read_restaurants') == false ? 'btn btn-default disabled':'btn btn-default','text'=>'<i class="fa fa-refresh"></i>'],
                    [
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name'=>'name',
                'data'=>'name',
                'title'=>trans('admin.Name of restaurant type')
            ],
            [
                'name'=>'status',
                'data'=>'status',
