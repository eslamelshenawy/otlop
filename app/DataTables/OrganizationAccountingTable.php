...
class OrganizationAccountingTable extends DataTable
{
    /**
...
//                ->addColumn('status', 'backend.vendor.order.btn.status')
                ->addColumn('balance', 'backend.vendor.order.btn.balance')
                ->addColumn('balance1', 'backend.vendor.order.btn.balance1')
                ->addColumn('balance2', 'backend.vendor.order.btn.balance2')
...
//                ],
                [
                    'name'=>'balance',
                    'data'=>'balance',
                    'title'=>trans('admin.balance')
                ],
                [
                    'name'=>'balance1',
                    'data'=>'balance1',
                    'title'=>trans('admin.balance1')
                ],
                [
                    'name'=>'balance2',
                    'data'=>'balance2',
                    'title'=>trans('admin.balance2')
                ],
                [
                    'name'=>'restaurant',
                    'data'=>'restaurant',
