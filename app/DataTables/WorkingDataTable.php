...
class WorkingDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'backend.vendor.working.btn.checkbox')
            ->addColumn('edit', 'backend.vendor.working.btn.edit')
            ->addColumn('status', 'backend.vendor.working.btn.status')
            ->addColumn('day', 'backend.vendor.working.btn.day')
            ->addColumn('from', 'backend.vendor.working.btn.from')
            ->addColumn('to', 'backend.vendor.working.btn.to')
            ->addColumn('delete', 'backend.vendor.working.btn.delete')
            ->rawColumns([
                'edit',
                'status',
                'delete',
    ...
    {
        return 'WorkingHours_' . date('YmdHis');
    }
}
